...
class Data {
  ...
  Data({this.id, this.portfolioID, this.domainID, this.companyID, this.screenType, this.projectName, this.description, this.uRLLink, this.documents, this.published, this.domainName, this.companyName, this.screenName, this.techMapping, this.imageMapping});
