...
class ApiService {
  ...
  static Future<List<Data>> fetchDataFromApi(
    ...
    try {
      // Your existing fetchDataFromApi logic
      ...
      // You need to implement the loadGridItemsFromDatabase method or replace it with your existing logic
  ...
  static Future<void> loadGridItemsFromDatabase() async {
    if (isDataLoaded) {
